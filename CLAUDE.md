...
- **Bot name resolution.** Bot name is taken from `config.botName` and defaults to "opencode". Set it in `~/.config/opencode/feishu.json` if you want a custom display name.
